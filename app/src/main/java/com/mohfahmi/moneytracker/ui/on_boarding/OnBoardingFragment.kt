...
import com.mohfahmi.moneytracker.ui.on_boarding.OnBoardingFragmentDirections.actionOnBoardingFragmentToHomeFragment
    ...
    private fun bindViews() {
        with(binding) {
            ...
            btnGetStarted.setOnClickListener {
                findNavController().navigate(actionOnBoardingFragmentToHomeFragment())
